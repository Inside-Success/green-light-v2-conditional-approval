...
- `reality` - Reality Show Conditional Casting Approval (added 2026-09-11). Uses Tom's reality template: no Story Formula/Thing/Mission sections; instead a Competitive Profile with four AI-filled paragraphs (Business Experience, Competitive Edge, Personality, The Wildcard). Keeps the deadline box and the default Inside Success header. No customer journey page until one is provided.

Current behavior:

- Normal shows include the `IMPORTANT` deadline section.
- Next Level CEO/NLCEO shows omit deadline and expiry language.
- Reality shows include the `IMPORTANT` deadline section and have no final customer journey page.
